# Generated by Django 3.1.1 on 2021-03-04 18:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_on', models.DateTimeField(default=datetime.datetime(2021, 3, 4, 18, 8, 38, 818842, tzinfo=utc))),
                ('order_status', models.IntegerField(choices=[(0, 'Completed'), (1, 'Cancelled'), (2, 'Quoted'), (3, 'Pending'), (4, 'Shipped'), (5, 'Payed')])),
                ('additional_value', models.CharField(max_length=200, null=True)),
                ('additional_cost', models.FloatField(default=0, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.serviceprovider'),
        ),
        migrations.CreateModel(
